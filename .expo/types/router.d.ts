...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(routes)` | `/(routes)/auth/signin` | `/(routes)/auth/signup` | `/(routes)/auth/verifyAccount` | `/(routes)/course/all-course` | `/(routes)/course/course-detail` | `/(routes)/follow/follower` | `/(routes)/follow/following` | `/(routes)/onboarding` | `/(routes)/profile-detail` | `/(routes)/profile-other` | `/(routes)/profile-other/teacher-courses` | `/(routes)/room/stream-room` | `/(routes)/room/waiting-room` | `/(routes)/upload/upload-course` | `/(routes)/upload/upload-video` | `/(routes)/upload/upload-video-course` | `/(routes)/video` | `/(routes)/video/all-video` | `/(routes)/welcome-intro` | `/(tabs)` | `/_sitemap` | `/auth/signin` | `/auth/signup` | `/auth/verifyAccount` | `/course/all-course` | `/course/course-detail` | `/follow/follower` | `/follow/following` | `/onboarding` | `/profile` | `/profile-detail` | `/profile-other` | `/profile-other/teacher-courses` | `/room` | `/room/stream-room` | `/room/waiting-room` | `/student-courses` | `/upload` | `/upload/upload-course` | `/upload/upload-video` | `/upload/upload-video-course` | `/video` | `/video/all-video` | `/welcome-intro`;
